  ...
  const validateForm = () => {
    ...
    if (isAddForm()) {
      ...
      if (!form.picture.value.startsWith(start) || !form.picture.value.endsWith(end)) {
          ...
          const newField: Field = { value: form.picture.value, error: erroMsg, isValid: false };
    ...
    if(!/^[a-zA-Zàéè ]{3,25}$/.test(form.name.value)) {
      const errorMsg: string = 'Le nom du pokémon est requis (1-25) et seulement des lettres.';
